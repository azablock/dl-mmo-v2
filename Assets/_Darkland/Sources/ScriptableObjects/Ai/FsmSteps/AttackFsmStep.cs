...
namespace _Darkland.Sources.ScriptableObjects.Ai.FsmSteps {

    [CreateAssetMenu(fileName = nameof(AttackFsmStep), menuName = "DL/Ai/" + nameof(AttackFsmStep))]
    public class AttackFsmStep : FsmStep {
